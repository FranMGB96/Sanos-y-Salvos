...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="filters">
        ...
        <button
          [class.active]="filtro === 'PERDIDO'"
          (click)="setFiltro('PERDIDO')"
        >
          Perdidos
        </button>

        <button
          [class.active]="filtro === 'ENCONTRADO'"
          (click)="setFiltro('ENCONTRADO')"
        >
          Encontrados
        </button>
  ...
  styles: [`
    ...
    /* EFECTO VISUAL TIPO GOOGLE MAPS */
    .google-style-map{
      filter:
        brightness(1.04)
        contrast(.96)
